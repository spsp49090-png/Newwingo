	...
	if ($_SERVER['REQUEST_METHOD'] != 'GET') {
		if (isset($shonupost['typeId']) && isset($shonupost['language']) && isset($shonupost['random']) && isset($shonupost['signature']) && isset($shonupost['timestamp'])) {
			...
			if($shonusign == $signature){				
						...
						$data[0]['url'] = 'https://h5.workorrder.support/?datablock=' . urlencode($author) . '&language=en&website=https%253A%252F%252Ftashan.investment93.site';
						$data[0]['sort'] = 2;
						
						// $data[1]['typeID'] = 3;
						// $data[1]['name'] = 'Self-service Bonus Service';
						// $data[1]['url'] = 'https://service.tashan.investment93.site/?datablock=' . urlencode($author) . '&language=en&website=https%253A%252F%252Ftashan.investment93.site';
						// $data[1]['sort'] = 0;
