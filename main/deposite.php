                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . $row["utr"] . "</td>";
                            echo "<td><a href='https://tashan.investment93.site/uploads/" . $row["file_upload"] . "'>" . $row["file_upload"] . "</a></td>";
                            echo "<td><a href='https://tashan.investment93.site/uploads/" . $row["image_upload"] . "'>" . $row["image_upload"] . "</a></td>";
